...
app.get("/", (req, res) => {
  res.send("CINE-MARK API");
});

// Liveness probe. Deliberately does not touch the database or Redis so that a
// slow dependency cannot make the process look dead to a deploy platform.
